...
////////////////////////////////////////////////////////////
iVector2f Transform::transformPoint(float x, float y) const
{
    return iVector2f(m_matrix[0] * x + m_matrix[4] * y + m_matrix[12],
                    m_matrix[1] * x + m_matrix[5] * y + m_matrix[13]);
}


////////////////////////////////////////////////////////////
iVector2f Transform::transformPoint(const iVector2f& point) const
{
...
////////////////////////////////////////////////////////////
Transform& Transform::translate(const iVector2f& offset)
{
...
////////////////////////////////////////////////////////////
Transform& Transform::rotate(float angle, const iVector2f& center)
{
...
////////////////////////////////////////////////////////////
Transform& Transform::scale(const iVector2f& factors)
{
...
////////////////////////////////////////////////////////////
Transform& Transform::scale(const iVector2f& factors, const iVector2f& center)
{
