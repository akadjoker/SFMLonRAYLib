...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    Vertex(const iVector2f& thePosition);
    ...
    ///
    /// \param thePosition Vertex position
    /// \param theiColor    Vertex color
    ///
    ////////////////////////////////////////////////////////////
    Vertex(const iVector2f& thePosition, const iColor& theiColor);
    ...
    ///
    ////////////////////////////////////////////////////////////
    Vertex(const iVector2f& thePosition, const iVector2f& theTexCoords);
    ...
    ///
    ////////////////////////////////////////////////////////////
    Vertex(const iVector2f& thePosition, const iColor& theiColor, const iVector2f& theTexCoords);

    ////////////////////////////////////////////////////////////
    // Member data
    ////////////////////////////////////////////////////////////
    iVector2f  position;  ///< 2D position of the vertex
    iColor     color;     ///< iColor of the vertex
    iVector2f  texCoords; ///< Coordinates of the texture's pixel to map to the vertex
};
...
/// sf::Vertex vertices[] =
/// {
///     sf::Vertex(sf::iVector2f(  0,   0), sf::iColor::Red, sf::iVector2f( 0,  0)),
///     sf::Vertex(sf::iVector2f(  0, 100), sf::iColor::Red, sf::iVector2f( 0, 10)),
///     sf::Vertex(sf::iVector2f(100, 100), sf::iColor::Red, sf::iVector2f(10, 10)),
///     sf::Vertex(sf::iVector2f(100,   0), sf::iColor::Red, sf::iVector2f(10,  0))
/// };
///
/// // draw it
