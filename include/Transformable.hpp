...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setPosition(const iVector2f& position);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setScale(const iVector2f& factors);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setOrigin(const iVector2f& origin);
    ...
    ///
    ////////////////////////////////////////////////////////////
    const iVector2f& getPosition() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    const iVector2f& getScale() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    const iVector2f& getOrigin() const;
    ...
    /// \code
    /// sf::iVector2f pos = object.getPosition();
    ...
    ///
    ////////////////////////////////////////////////////////////
    void move(const iVector2f& offset);
    ...
    /// Thus, it is equivalent to the following code:
    /// \code
    /// sf::iVector2f scale = object.getScale();
    ...
    ///
    ////////////////////////////////////////////////////////////
    void scale(const iVector2f& factor);
...
private:
    ...
    // Member data
    ////////////////////////////////////////////////////////////
    iVector2f          m_origin;                     ///< Origin of translation/rotation/scaling of the object
    iVector2f          m_position;                   ///< Position of the object in the 2D world
    float             m_rotation;                   ///< Orientation of the object, in degrees
    iVector2f          m_scale;                      ///< Scale of the object
