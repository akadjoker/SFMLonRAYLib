...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    iVector2f transformPoint(float x, float y) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    iVector2f transformPoint(const iVector2f& point) const;
    ...
    /// \code
    /// sf::Transform transform;
    /// transform.translate(sf::iVector2f(100, 200)).rotate(45);
    /// \endcode
    ///
    ...
    ///
    ////////////////////////////////////////////////////////////
    Transform& translate(const iVector2f& offset);
    ...
    /// \code
    /// sf::Transform transform;
    /// transform.rotate(90, sf::iVector2f(8, 3)).translate(sf::iVector2f(50, 20));
    /// \endcode
    ///
    /// \param angle Rotation angle, in degrees
    ...
    ///
    ////////////////////////////////////////////////////////////
    Transform& rotate(float angle, const iVector2f& center);
    ...
    /// \code
    /// sf::Transform transform;
    /// transform.scale(sf::iVector2f(2, 1)).rotate(45);
    /// \endcode
    ///
    ...
    ///
    ////////////////////////////////////////////////////////////
    Transform& scale(const iVector2f& factors);
    ...
    /// \code
    /// sf::Transform transform;
    /// transform.scale(sf::iVector2f(2, 1), sf::iVector2f(8, 3)).rotate(45);
    /// \endcode
    ///
    /// \param factors Scaling factors
    ...
    ///
    ////////////////////////////////////////////////////////////
    Transform& scale(const iVector2f& factors, const iVector2f& center);
...
///
////////////////////////////////////////////////////////////
 iVector2f operator *(const Transform& left, const iVector2f& right);
...
/// sf::iVector2f point = transform.transformPoint(10, 20);
