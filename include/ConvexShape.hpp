...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    void setPoint(std::size_t index, const iVector2f& point);
    ...
    ///
    ////////////////////////////////////////////////////////////
    virtual iVector2f getPoint(std::size_t index) const;
...
private:
    ...
    // Member data
    ////////////////////////////////////////////////////////////
    std::vector<iVector2f> m_points; ///< Points composing the convex polygon
};
...
/// polygon.setPoint(0, sf::iVector2f(0, 0));
/// polygon.setPoint(1, sf::iVector2f(0, 10));
/// polygon.setPoint(2, sf::iVector2f(25, 5));
/// polygon.setOutlineiColor(sf::iColor::Red);
